...
export default function HomeScreen() {
  ...
  const handleSOS = () => {
    Alert.alert(
      ...
      'This will call 000 and share your location with emergency services.',
      [
  ...
  const getPinColor = (type: string) => {
    if (type === 'Weapon sighting' || type === 'Threatening behaviour') {
          ...
          incidents.slice(0, 5).map((inc) => (
            <View
              ...
              style={[
                ...
                {
                  borderLeftColor:
                    inc.type === 'Weapon sighting' ||
                    inc.type === 'Threatening behaviour'
                      ? Colors.danger
                      : Colors.warning,
                },
              ]}
